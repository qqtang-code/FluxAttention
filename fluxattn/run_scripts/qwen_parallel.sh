...
model=${MODEL:-"/workspace/mnt/hf_models/Qwen3-4B"}
...
end_head_sparsity=${END_HEAD_SPARSITY:-0.45}
...
# Create run name
suffix=${SUFFIX:-"4.3"}
extra_name="full_streaming_layer_router"
...
run_name="${suffix}steps${steps}_${extra_name}_end_${end_head_sparsity}_${model_name}"
