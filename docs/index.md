...
<section id="top" class="hero">
  ...
  <p class="tagline">Adaptive hybrid attention for efficient long-context inference.</p>
  <div class="hero-chips">
    <span>Adaptive Layer Router</span>
    <span>Full + Sparse Hybrid</span>
    <span>Long-Context Ready</span>
  </div>
...
<section id="overview" class="section-block">
  ...
  <p>
    Flux Attention routes each attention layer to full or sparse execution based on context signals,
    keeping long-context quality while reducing inference cost.
  </p>
</section>

<section id="architecture" class="section-block architecture">
  <h2>Architecture At A Glance</h2>
  <p>Layer routing decides when to use full or sparse attention during a single forward pass.</p>
  <figure>
...
<section id="quickstart" class="section-block">
  <h2>Quick Start</h2>
  <p>Use the demo scripts below to install, train, and evaluate quickly.</p>

  <h3>Installation</h3>
  <pre><code>conda create -n flux_attn python=3.11
...
pip install -e .</code></pre>
  ...
  <h3>Training</h3>
  <pre><code>chmod +x fluxattn/run_scripts/training.sh
cd fluxattn
bash run_scripts/training.sh</code></pre>

  <h3>Evaluation</h3>
  <p>For long-context benchmarks, use <a href="https://github.com/LCM-Lab/LOOM-Eval" target="_blank" rel="noopener">LOOM-Eval</a>.</p>
</section>
...
<section id="citation" class="section-block citation">
  <h2>Citation</h2>
  <pre><code>@misc{qiu2026fluxattentioncontextawarehybrid,
